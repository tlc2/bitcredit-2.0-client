...
maintained:
* for `src/secp256k1`: https://github.com/bitcredit-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/bitcredit-core/leveldb.git (branch bitcredit-fork)
* for `src/univalue`: https://github.com/bitcredit-core/univalue.git (branch master)
...
bitcredit/bitcredit repository.
...
Setup
---------
Configuring the github-merge tool for the bitcredit repository is done in the following way:

    git config githubmerge.repository bitcredit/bitcredit
...
A script to optimize png files in the bitcredit
