...
// Copyright (c) 2009-2012 The Bitcredit Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Bitcredit/$1-%s The Bitcredit/' %s"
REGEX_CURRENT= re.compile("%s The Bitcredit" % year)
