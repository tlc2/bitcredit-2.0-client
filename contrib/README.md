...
PGP keys used for signing Bitcredit Core [Gitian release](/doc/release-process.md) results.
...
This script attempts to download and verify the signature file SHA256SUMS.asc from bitcredit.org.
