Bitcredit Core version 0.9.2.1 is now available from:

  https://bitcredit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BCR to 0.01 BCR
...
- Fix "Start bitcredit on system login"
