Bitcredit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcredit/files/Bitcredit/bitcredit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitcredit
...
New/changed settings (command-line or bitcredit.conf file)
--------------------------------------------------------
