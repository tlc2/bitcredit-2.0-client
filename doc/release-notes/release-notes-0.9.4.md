Bitcredit Core version 0.9.4 is now available from:

  https://bitcredit.org/bin/0.9.4/
...
this update is incompatible with the Bitcredit system and could lead to consensus
forks.

Bitcredit Core released binaries from https://bitcredit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcredit/+archive/ubuntu/bitcredit
- A third-party or self-compiled Bitcredit Core

upgrade to Bitcredit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
