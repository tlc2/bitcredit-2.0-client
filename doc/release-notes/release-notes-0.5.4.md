Bitcredit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcredit/files/Bitcredit/bitcredit-0.5.4/
...
http://gitorious.org/bitcredit/bitcreditd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitcredit-Qt notifications under Growl 1.3.
Increase required age of Bitcredit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcredit properly when installing Bitcredit-Qt over it. (Windows)
