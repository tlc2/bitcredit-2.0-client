Bitcredit Core version 0.10.4 is now available from:

  <https://bitcredit.org/bin/bitcredit-core-0.10.4/>
...
- #6953 `43c2789` Split bitcredit-tx into its own package
- #6953 `dfe0d4d` Include bitcredit-tx binary on Debian/Ubuntu
