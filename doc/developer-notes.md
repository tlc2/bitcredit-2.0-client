...
However, in open source software such as Bitcredit Core, where everyone uses
...
pay attention to for reviewers of Bitcredit Core code.

General Bitcredit Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Bitcredit Core uses tinyformat, which is type safe. Leave them out to avoid confusion
