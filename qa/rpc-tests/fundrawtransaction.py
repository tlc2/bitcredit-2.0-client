...
class RawTransactionsTest(BitcreditTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bitcredit address")
        except JSONRPCException,e:
            assert("changeAddress must be a valid bitcredit address" in e.error['message'])
