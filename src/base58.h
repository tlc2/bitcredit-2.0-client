...
public:
    ...
    CBitcreditExtKeyBase(const std::string& strBase58c) {
...
typedef CBitcreditExtKeyBase<CExtKey, BIP32_EXTKEY_SIZE, CChainParams::EXT_SECRET_KEY> CBitcreditExtKey;
typedef CBitcreditExtKeyBase<CExtPubKey, BIP32_EXTKEY_SIZE, CChainParams::EXT_PUBLIC_KEY> CBitcreditExtPubKey;
