    ...
    mapper(0)
{
    ...
    ui->bitcreditAtStartup->setToolTip(ui->bitcreditAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcreditAtStartup->setText(ui->bitcreditAtStartup->text().arg(tr(PACKAGE_NAME)));
