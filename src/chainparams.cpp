...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1466613930, 7, 0x2000ffff, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //MineNewGenesisBlock();
        assert(consensus.hashGenesisBlock == uint256S("0x0053c6fe541c25f251342181bbcaaf848bbd30a152181445eafac112a1ec3205"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (0, uint256S("0x0053c6fe541c25f251342181bbcaaf848bbd30a152181445eafac112a1ec3205")),
            1466613930, // * UNIX timestamp of last checkpoint block
