...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bitcredit";
#else
    // Unix
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", BITCREDIT_CONF_FILENAME));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", BITCREDIT_PID_FILENAME));
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strCopyrightHolders.find("Bitcredit Core developers") == strCopyrightHolders.npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Bitcredit Core developers";
    }
