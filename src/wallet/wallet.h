...
#ifndef BITCREDIT_WALLET_WALLET_H
#define BITCREDIT_WALLET_WALLET_H
...
public:
    ...
    bool CreateTransaction(const std::vector<CRecipient>& vecSend, CWalletTx& wtxNew, CReserveKey& reservekey, CAmount& nFeeRet, int& nChangePosInOut,
                           std::string& strFailReason, std::string strTxComment, const CCoinControl *coinControl = NULL, bool sign = true);
...
#endif // BITCREDIT_WALLET_WALLET_H
